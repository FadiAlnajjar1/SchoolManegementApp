...
// Dtos/RegisterFcmRequest.cs
public class RegisterFcmRequest
{
    public string FcmToken { get; set; } = string.Empty;
}

// Dtos/UnregisterFcmRequest.cs
public class UnregisterFcmRequest
{
    public string FcmToken { get; set; } = string.Empty;
}
public class LoginResponse
{
    ...
    public string? FcmToken { get; set; } // ✅ إضافة FcmToken

    public LoginResponse(string token, UserType userType, string role, int id, string name, int? schoolId, int? localId = null, string? fcmToken = null)
    {
        Token = token;
        UserType = userType;
        Role = role;
        ...
        Name = name;
        SchoolId = schoolId;
        FcmToken = fcmToken; // ✅ تعيين FcmToken
    }
}
// Dtos/RegisterFcmRequest.cs
