...
namespace SchoolManagement.Api.Migrations
{
    ...
    [Migration("20260816190706_AddRejectionReasonAndUpdatedAtToReservation13")]
    partial class AddRejectionReasonAndUpdatedAtToReservation13
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grade", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "LocalGradeNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.Activity", b =>
                {
                    ...
                    b.Property<int>("LocalActivityId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SchoolId", "LocalActivityId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.Announcement", b =>
                {
                    ...
                    b.Property<int>("LocalAnnouncementId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SchoolId", "LocalAnnouncementId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.Book", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "LocalBookNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.FcmToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.OtpCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.QuizMark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentId", "SubjectId", "Semester", "QuizNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.ScheduleImage", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "TeacherId", "Type")
                        .IsUnique()
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.Student", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "LocalStudentNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("Subject", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "LocalSubjectId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SchoolManagement.Api.Models.ActivityRegistration", b =>
                {
                    ...
                    b.HasOne("SchoolManagement.Api.Models.Activity", null)
